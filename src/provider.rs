//! Provider abstraction for sandbox management.
//!
//! The `SandboxProvider` trait abstracts sandbox lifecycle operations so that
...
pub struct ProviderInfo {
    ...
    /// Maximum number of sandboxes this provider can manage (None = unlimited).
...
/// A sandbox provider manages sandbox lifecycle on some infrastructure.
///
...
pub trait SandboxProvider: Send + Sync {
    ...
    /// Delete a sandbox (stops it first if running).
